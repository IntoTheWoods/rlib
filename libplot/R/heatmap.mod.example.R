...
#Create heatmap using custom heatmap.mod source code loaded above
#pdf(file="heatmap3_example.pdf")
main_title="Drug Response Predictions"
par(cex.main=1)
heatmap.mod(prob_matrix, hclustfun=myclust, distfun=mydist, na.rm = TRUE, scale="none", dendrogram="both", margins=c(6,12),
...
#
#heatmap.mod(mat, RowSideColors=row_annotation, ColSideColors=column_annotation)
}
